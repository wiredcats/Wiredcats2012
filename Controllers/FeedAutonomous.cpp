#include "FeedAutonomous.h"

FeedAutonomous2415::FeedAutonomous2415(void) {
	global = new Global();
	...
	taskState = START;	
	Start("feedautonomous2415");
}

int FeedAutonomous2415::Main(int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10) {
